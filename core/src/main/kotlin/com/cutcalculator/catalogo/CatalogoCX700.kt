 ...
 *
 * Sei tipologie, stessa struttura del [CatalogoRX700] (cambiano gli offset): **finestra 1/2 ante**
 * (anta `CX70.201` + fermavetro `CX70.566`, montante d'incontro `CX70.301`) e **porta 1/2 ante**
 * (stessi profili + traverso `CX70.402`), queste ultime in **due varianti**. Il fermavetro è una
 * barra rettangolare → taglio 90/90.
 *
...
object CatalogoCX700 {
    ...
    private fun finestraDueAnte(): Tipologia = Tipologia(
        ...
        listOf(
            ...
            RegolaTaglio(
                "Fermavetro (lato orizzontale)", FERMAVETRO, perMezzaL(164.5), 4, TAGLIO_90_90
            ),
    ...
    private fun portaDueAnte(conTraverso: Boolean): Tipologia {
        ...
        return Tipologia(
            ...
            listOf(
                ...
                RegolaTaglio("Anta (lato verticale)", ANTA, perH(44.0), 4, TAGLIO_45_45),
                RegolaTaglio(
                    "Fermavetro (lato orizzontale)", FERMAVETRO, perMezzaL(164.5), 8, TAGLIO_90_90
                ),
                RegolaTaglio(
