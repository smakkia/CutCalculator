...
public final class CatalogoRX700 {
    ...
    private static final Profilo TELAIO = new Profilo("RX70.101", "Telaio", Categoria.TELAIO, 1.280);
    private static final Profilo ANTA = new Profilo("RX70.201", "Anta", Categoria.ANTA, 1.503);
    ...
    private static final Profilo TRAVERSO_PORTA = new Profilo("RX70.402", "Traverso porta", Categoria.MONTANTE, 2.001);
